...
struct Drivers {
	...
	SpiMaster spi{loop,
		...
		gpio::Config::PB14 | gpio::Config::AF5 | gpio::Config::PULL_UP, // SPI2 MISO (CN10 28)
		gpio::Config::PB15 | gpio::Config::AF5 | gpio::Config::SPEED_MEDIUM, // SPI2 MOSI (CN10 26)
		gpio::Config::PA8, // DC (CN9 8)
		spi::SPI2_INFO,
		dma::DMA1_CH1_CH2_INFO,*/

		/*gpio::Config::PB3 | gpio::Config::AF6 | gpio::Config::SPEED_MEDIUM, // SPI3 SCK (CN9 4)
		gpio::Config::NONE, // no MISO, send only
		gpio::Config::PB5 | gpio::Config::AF6 | gpio::Config::SPEED_MEDIUM, // SPI3 MOSI (CN9 5)
		gpio::Config::PA8, // DC (CN9 8)
		spi::SPI3_INFO,
		dma::DMA1_CH1_CH2_INFO,*/
