...
struct Drivers {
	...
	SpiMaster spi{loop,
		gpio::Config::PA5 | gpio::Config::AF0 | gpio::Config::SPEED_MEDIUM, // SPI1 SCK (don't forget to lookup the alternate function number in the data sheet!)
		gpio::Config::PA6 | gpio::Config::AF0 | gpio::Config::PULL_UP, // SPI1 MISO
		gpio::Config::PA7 | gpio::Config::AF0 | gpio::Config::SPEED_MEDIUM, // SPI1 MOSI
		gpio::Config::PA8 | gpio::Config::SPEED_MEDIUM, // DC
		spi::SPI1_INFO,
		dma::DMA1_CH2_CH3_INFO,

		/*gpio::Config::PB13 | gpio::Config::AF0 | gpio::Config::SPEED_MEDIUM, // SPI2 SCK
		gpio::Config::PB14 | gpio::Config::AF0 | gpio::Config::PULL_UP, // SPI2 MISO
		gpio::Config::PB15 | gpio::Config::AF0 | gpio::Config::SPEED_MEDIUM, // SPI2 MOSI
		gpio::Config::PA8 | gpio::Config::SPEED_MEDIUM, // DC
		spi::SPI2_INFO,
